...
Features include:
  ...
  - Numerical integration methods for the best performing model in a discounting series
...
* R Statistical Package - GPLv2+ Licensed. Copyright (C) 2000-17. The R Core Team [Site](https://www.r-project.org/)
...
* nls R Package (stats) - GPLv2+ Licensed. Copyright (C) 1999-1999 Saikat DebRoy, Douglas M. Bates, Jose C. Pinheiro.
* nls R Package (stats) - GPLv2+ Licensed. Copyright (C) 2000-17. The R Core Team.
* integrate R package (stats) - GPLv2+ Licensed. Copyright (C) 2000-17. The R Core Team.
